...
namespace Higher_Institution.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public IActionResult Register(string returnUrl = null)
        {
            ...
            ViewData["SemesterID"] = new SelectList(_context.Semester.OrderBy(m=>m.Name), "SemesterID", "Name");
            ViewData["LevelID"] = new SelectList(_context.Level.OrderByDescending(m => m.Name), "LevelID", "Name");
            ViewData["ReturnUrl"] = returnUrl;
            return View();
        }
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Register(RegisterViewModel model, IFormFile ProfilePictureFile, string returnUrl = null)
        {
            ViewData["ReturnUrl"] = returnUrl;
            if (ModelState.IsValid)
            {
                if (ProfilePictureFile != null)
                {
                    ...
                    string uploadPath = Path.Combine(_environment.WebRootPath, "images/student/");
